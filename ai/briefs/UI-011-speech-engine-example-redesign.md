# UI-011: Speech Engine Example App Redesign
...
The fifty_speech_engine example app needs redesign to match the new FDL v2 patterns established in fifty_achievement_engine:
...
5. Showcase all speech engine features comprehensively

---

## Scope

**Package:** `packages/fifty_speech_engine/example/`
...
- [ ] All speech features demonstrated
