/// App Exceptions
///
/// Custom exception types for error handling in the demo app.
library;

// Error key constants (since we don't have a full localization system)
const String tkError = 'Error';
const String tkAuthError = 'Auth Error';
const String tkApiError = 'API Error';
const String tkNetworkError = 'Network Error';
const String tkFetchingError = 'Fetching Error';
