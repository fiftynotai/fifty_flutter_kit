/// Demo Sentences
///
/// Sample sentence sequences for the demo implementing BaseNarrativeModel
/// from the fifty_narrative_engine package.
library;

import 'package:fifty_narrative_engine/fifty_narrative_engine.dart';

/// A single sentence in the demo implementing [BaseNarrativeModel].
///
...
class DemoNarrative implements BaseNarrativeModel {
  ...
  // ─────────────────────────────────────────────────────────────────────────
  // BaseNarrativeModel Implementation
  // ─────────────────────────────────────────────────────────────────────────
...
abstract class DemoNarratives {
  ...
  static const List<DemoNarrative> readMode = [
    DemoNarrative(
      id: 'read_1',
  ...
  static const List<DemoNarrative> waitMode = [
    DemoNarrative(
      id: 'wait_1',
  ...
  static const List<DemoNarrative> askMode = [
    DemoNarrative(
      id: 'ask_1',
  ...
  static const List<DemoNarrative> navigateMode = [
    DemoNarrative(
      id: 'nav_1',
  ...
  static const List<DemoNarrative> combinedMode = [
    DemoNarrative(
      id: 'combo_1',
  ...
  static const List<DemoNarrative> orderQueue = [
    DemoNarrative(
      id: 'order_3',
  ...
  static const List<DemoNarrative> introduction = [
    DemoNarrative(
      id: 'intro_1',
      text: 'Welcome to the Narrative Engine demonstration.',
      speaker: 'SYSTEM',
      instruction: 'write',
      delayMs: 2000,
    ),
  ...
  /// Tutorial dialogue.
  static const List<DemoNarrative> tutorial = [
    DemoNarrative(
      id: 'tut_1',
  ...
  /// Story dialogue.
  static const List<DemoNarrative> story = [
    DemoNarrative(
      id: 'story_1',
  ...
  static const List<DemoNarrative> conversation = [
    DemoNarrative(
      id: 'conv_1',
  ...
  static List<DemoNarrative> forMode(DemoMode mode) {
    return switch (mode) {
  ...
  static const Map<String, List<DemoNarrative>> all = {
