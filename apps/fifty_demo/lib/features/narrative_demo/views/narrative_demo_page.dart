...
class NarrativeDemoPage extends GetView<NarrativeDemoViewModel> {
  /// Creates a sentences demo page.
  const NarrativeDemoPage({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<NarrativeDemoViewModel>(
      builder: (viewModel) {
        final actions = Get.find<NarrativeDemoActions>();
  ...
  Widget _buildStatusBar(BuildContext context, NarrativeDemoViewModel viewModel) {
  ...
  Widget _buildModeSelector(
    ...
    NarrativeDemoViewModel viewModel,
    NarrativeDemoActions actions,
  ) {
    final colorScheme = Theme.of(context).colorScheme;
  ...
  String _getHintText(NarrativeDemoViewModel viewModel) {
