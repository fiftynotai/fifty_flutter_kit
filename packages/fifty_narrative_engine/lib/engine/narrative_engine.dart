...
///
/// Used to indicate the current state of the narrative engine.
...
/// - Deduplicate writing using external `SafeNarrativeWriter`
///
/// **Usage Example:**
/// ```dart
...
class NarrativeEngine {
  ...
  final List<BaseNarrativeModel> _processedSentences = <BaseNarrativeModel>[];
  ...
  final ValueChanged<List<BaseNarrativeModel>>? onSentencesChanged;
  ...
  final ListQueue<BaseNarrativeModel> _queue = ListQueue();
  ...
  void addSentenceToWritten(BaseNarrativeModel baseSentenceModel) {
