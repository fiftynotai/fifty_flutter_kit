/// Fifty Narrative Engine - A sentence processing engine for games and interactive applications.
///
...
export 'engine/narrative_engine.dart';

import 'fifty_narrative_engine_platform_interface.dart';

/// Main entry point for FiftyNarrativeEngine plugin.
///
/// Provides platform version information.
class FiftyNarrativeEngine {
  /// Returns the platform version string.
  Future<String?> getPlatformVersion() {
    return FiftyNarrativeEnginePlatform.instance.getPlatformVersion();
  }
}
