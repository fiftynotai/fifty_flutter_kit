...
import 'package:fifty_world_engine/src/components/base/spawner.dart';
import 'package:fifty_world_engine/src/services/asset_loader_service.dart';
...
/// **FiftyWorldBuilder**
///
/// A high-level `FlameGame` that renders and manages the interactive Fifty world.
...
///   handled by your entity/component logic via [FiftyWorldEntity.position]).
...
class FiftyWorldBuilder extends FlameGame
  ...
  /// **Creates a new [FiftyWorldBuilder].**
  ///
  ...
  /// via [_onNewEntity].
  Future<void> addEntities(List<FiftyWorldEntity> models) async {
  ...
  void removeEntity(FiftyWorldEntity model) {
  ...
  /// to the [world].
  void spawnEntity(FiftyWorldEntity model) {
  ...
  void saveEntity(FiftyWorldEntity entity, FiftyBaseComponent component) {
  ...
  void _onNewEntity(FiftyWorldEntity model) {
