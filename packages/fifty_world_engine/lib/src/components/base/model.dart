...
/// - Returns void.
typedef FiftyWorldTapCallback = void Function(FiftyWorldEntity model);

/// **Enumerated types of in-game map events**
///
/// Used by [FiftyWorldEvent] to indicate visual and logical event types
...
///
/// Used by [FiftyWorldEvent.alignment] to determine where an event
...
///
/// **Used in:** [FiftyWorldEntity.event]
class FiftyWorldEvent {
  final String text;
  ...
  factory FiftyWorldEvent.fromJson(Map<String, dynamic> json) {
    return FiftyWorldEvent(
...
/// **Model for a map entity in Fifty World Engine**
///
...
/// - [event]: optional [FiftyWorldEvent]
...
class FiftyWorldEntity {
  ...
  final String? text;
  final FiftyWorldEvent? event;
  final List<FiftyWorldEntity> components;
  ...
  FiftyWorldEntity({
    ...
    double? x,
    double? y,
  })  : x = x ?? gridPosition.x * FiftyWorldConfig.blockSize,
        y = y ?? gridPosition.y * FiftyWorldConfig.blockSize;
  ...
  Vector2 get size => Vector2(
        blockSize.width * FiftyWorldConfig.blockSize,
        blockSize.height * FiftyWorldConfig.blockSize,
      );

  /// **Parses a map entity from JSON.**
  factory FiftyWorldEntity.fromJson(Map<String, dynamic> json) {
    try {
      return FiftyWorldEntity(
        ...
        event: json['event'] != null
            ? FiftyWorldEvent.fromJson(json['event'] as Map<String, dynamic>)
            : null,
        components: (json['components'] as List?)
                ?.map((e) => FiftyWorldEntity.fromJson(e as Map<String, dynamic>))
                .toList() ??
            [],
  ...
  @override
  String toString() =>
      'FiftyWorldEntity(id: $id, type: $type, position: $position, size: $size)';

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is FiftyWorldEntity &&
...
/// **Recognized map entity types in Fifty World Engine**
///
