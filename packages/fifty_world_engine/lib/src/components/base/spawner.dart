import 'package:fifty_world_engine/src/components/event_component.dart';
import 'package:fifty_world_engine/src/components/room_component.dart';
import 'package:fifty_world_engine/src/components/sprites/animated_entity_component.dart';
import 'package:fifty_world_engine/src/utils/logger.dart';
...
///
/// Converts a [FiftyWorldEntity] into the appropriate [FiftyBaseComponent]
...
class FiftyEntitySpawner {
  ...
  static final Map<String, FiftyBaseComponent Function(FiftyWorldEntity)>
      _customSpawners = {};
  ...
  static void register(
    String type,
    FiftyBaseComponent Function(FiftyWorldEntity) builder,
  ) {
  ...
  static FiftyBaseComponent spawn(FiftyWorldEntity model) {
    // Custom override
    ...
    switch (model.entityType) {
      ...
      default:
        FiftyWorldLogger.instance.warning(
