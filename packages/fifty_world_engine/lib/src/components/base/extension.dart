...
/// **Extensions for `FiftyWorldEntity`**
///
...
extension FiftyWorldEntityExtension on FiftyWorldEntity {
  ...
  ///
  /// Returns a new [FiftyWorldEntity] without mutating the original.
  FiftyWorldEntity copyWith({
    String? id,
    String? parentId,
    String? type,
    String? asset,
    ...
    String? text,
    FiftyWorldEvent? event,
    List<FiftyWorldEntity>? components,
  ...
  ///
  /// Returns a new [FiftyWorldEntity] at the new position.
  FiftyWorldEntity changePosition({
    required Vector2 gridPosition,
  }) {
    return copyWith(
      gridPosition: gridPosition,
      x: gridPosition.x * FiftyWorldConfig.blockSize,
      y: gridPosition.y * FiftyWorldConfig.blockSize,
    );
  }
  ...
  ///
  /// Returns a new [FiftyWorldEntity] with updated `x` and `y`.
  FiftyWorldEntity copyWithParent(Vector2 parentPosition) {
    return copyWith(
