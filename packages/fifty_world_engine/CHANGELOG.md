...
### Fixed
- Replaced deprecated `FiftyColors` references in example app (slateGrey→secondary, burgundy→primary)

## [0.1.3] - 2026-03-04

### Documentation
- Rewrite README with tile grid, pathfinding, overlays, and animation queue documentation
