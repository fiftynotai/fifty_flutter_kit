...
### Documentation
- Rewrite README with selling-points-first structure, builder customization docs, and Why section
...
- Form widgets resolve colors from `colorScheme` instead of direct `FiftyColors.*`
- Updated dependency constraints: `fifty_tokens: ^2.0.0`, `fifty_theme: ^2.0.0`, `fifty_ui: ^0.7.0`
